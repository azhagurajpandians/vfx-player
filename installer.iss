; =====================================================================
; Inno Setup Script for VFX Review Player
...
[Setup]
AppId={{A2D89C41-995F-46E1-80DF-1B053C2D89F1}
AppName={#MyAppName}
...
[Files]
Source: "dist\VFX Review Player\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
